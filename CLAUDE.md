...
- `app/pages/raids/index.vue`, `app/pages/raids/[code].vue`: recent raid nights from Warcraft Logs; the list shows bosses down and headcount, the detail page shows the boss list (pulls collapsed to one row per boss) and who was there, grouped tank / healer / dps
